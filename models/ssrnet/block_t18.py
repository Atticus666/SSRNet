...
class StructuralSparseBlockT18(layers.Layer):
    """
    ...
    def __init__(self, 
                 ...
                 l2_reg: float = 0.0,
                 stage_name: str = "structural_sparse_block_t18",
                 **kwargs):
        """
        Initialize StructuralSparseBlockT18.
        ...
        """
        super(StructuralSparseBlockT18, self).__init__(name=stage_name, **kwargs)
    ...
    def build(self, input_shape):
        ...
        for token_id in range(self.tokennum):
            ...
            # Batch normalization
            # batch_norm = layers.BatchNormalization(name=f"bn_{token_id}")
        ...
        super(StructuralSparseBlockT18, self).build(input_shape)
